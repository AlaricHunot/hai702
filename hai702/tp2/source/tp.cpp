...
Vec3 project(Vec3 const &input_point, Plane const &i_plane) {
    ...
    return input_point-(Vec3().dot(input_point-i_plane.point,i_plane.normal)/i_plane.normal.squareLength())*i_plane.normal;
}
...
int main(int argc, char **argv) {
    ...
    Vec3 scale(1., 3., 1.); //Mise à l'échelle non uniforme
